...
class SearchForm(forms.ModelForm):
    serch = forms.CharField(widget=forms.TextInput(attrs={'class': 'form-control'}))
...
class MyPasswordResetForm(PasswordResetForm):
    email = forms.EmailField(label=_('Email'), max_length=245, widget=forms.EmailInput(attrs={'autocomplete': 'email',
...
class CustomerProfileForm(forms.ModelForm):
    class Meta:
        model = Customer
        fields = ['name', 'village', 'postcode', 'thana', 'district']
        widgets = {
